...
export class CheckoutAuthController {
  ...
  // 🔒 F2-02/F-11: resolve the real client IP via the trusted-proxy resolver.
  // Forwarding headers are only honored when the request arrives from a trusted
  // proxy hop, preventing X-Forwarded-For spoofing to bypass rate limits.
