...
export class SubscriptionsService {
  ...
  /**
   * ترقية الاشتراك (بعد الدفع) — معطّلة للمستخدمين؛ تتم عبر تذكرة دعم أو أدمن
   */
  async upgradePlan(
    _userId: string,
    ...
    throw new BadRequestException(
      'Self-service plan upgrades are disabled. Open a billing support ticket to upgrade or renew.',
    );
  }
