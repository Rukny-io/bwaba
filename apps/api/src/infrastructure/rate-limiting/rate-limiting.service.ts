...
export class RateLimitingService implements OnModuleInit {
  ...
  private readonly endpointLimits: Record<string, RateLimitConfig> = {
    ...
    'POST:/auth/password/set': { limit: 5, window: 3600 },
    'POST:/auth/password/change': { limit: 5, window: 3600 },
    'DELETE:/auth/password': { limit: 5, window: 3600 },
    'POST:/auth/email/send-verification': { limit: 3, window: 600 },
    'POST:/auth/email/verify': { limit: 10, window: 600 },
