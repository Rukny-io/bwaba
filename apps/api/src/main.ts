...
async function bootstrap() {
  ...
  // 🔒 F-11: Prefetch Cloudflare IP ranges so getClientIp() can validate that
  // forwarding headers actually originate from a trusted proxy hop.
  await TrustedProxyResolver.init().catch(() => undefined);
