/**
 * إدارة مساحة العمل النشطة (Workspace switcher) لتطبيق المتجر.
 *
 * - نخزّن معرّف مساحة العمل النشطة في cookie `active_workspace_id`.
 * - كل استدعاءات الـ API تُضيف ترويسة `X-Workspace-Id` إن كانت هناك مساحة مختارة.
 */
