...
/**
 * شريط تنبيه دائم أعلى الصفحة يوضح أن المستخدم يعمل داخل مساحة ليست له.
 */
export function ForeignWorkspaceBanner({
  ...
  return (
    <div
      role="status"
      className="flex flex-wrap items-center justify-center gap-x-3 gap-y-1 bg-amber-500/95 px-3 py-1.5 text-center text-xs font-medium text-black shadow-sm sm:text-sm dark:bg-amber-400"
    >
