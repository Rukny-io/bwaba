...
import { FormWorkspaceProvider } from '@/components/forms/workspace/form-workspace-context';
...
export default async function FormWorkspaceLayout({
  ...
  return (
    <FormWorkspaceProvider form={form}>
      <div className="dashboard-page flex w-full flex-col gap-5 sm:gap-6">
        <FormWorkspaceNav
          formId={id}
          formSlug={form?.slug}
