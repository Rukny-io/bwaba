...
function CallbackContent() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // Full navigation so middleware receives Set-Cookie from the exchange
    ...
    return (
      <AuthShell>
        <section className="w-full bg-[var(--background)]/95 px-5 py-6 sm:px-7 sm:py-8 shadow-sm border border-[var(--border)] rounded-2xl flex flex-col items-center text-center">
          <h1 className="text-xl font-bold tracking-tight text-[var(--foreground)] mb-4">تعذر تسجيل الدخول</h1>
  ...
  return (
    <AuthShell>
      <section className="w-full bg-[var(--background)]/95 px-5 py-6 sm:px-7 sm:py-8 shadow-sm border border-[var(--border)] rounded-2xl flex flex-col items-center text-center">
        <h1 className="text-xl font-bold tracking-tight text-[var(--foreground)] mb-4">جارٍ تسجيل الدخول</h1>
  ...
  return (
    <Suspense
      fallback={
        <AuthShell>
          <section className="w-full bg-[var(--background)]/95 px-5 py-6 sm:px-7 sm:py-8 shadow-sm border border-[var(--border)] rounded-2xl flex flex-col items-center text-center">
            <h1 className="text-xl font-bold tracking-tight text-[var(--foreground)] mb-4">جارٍ التحميل</h1>
            <p className="text-sm text-[var(--muted-foreground)] text-center">...</p>
          </section>
        </AuthShell>
      }
    >
