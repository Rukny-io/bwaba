...
export function FormDetailView({ formId }: { formId: string }) {
  ...
  if (error && !form) {
    return (
      <div className="rounded-2xl border border-[var(--danger)]/30 bg-[var(--danger)]/10 px-4 py-6 text-sm text-[var(--danger)]">
        ...
        <div className="mt-4">
          <Link href="/app/forms">
            <Button variant="tertiary">العودة إلى النماذج</Button>
          </Link>
        </div>
      </div>
    );
  ...
  return (
    <div className="space-y-5 sm:space-y-6">
      <div className="flex flex-col gap-3 rounded-2xl border border-[var(--border)]/80 bg-[var(--surface-secondary)]/40 px-4 py-3 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between">
      ...
      <div className="rounded-2xl bg-[var(--surface)] p-4 shadow-sm shadow-black/[0.02] sm:rounded-3xl sm:p-6">
