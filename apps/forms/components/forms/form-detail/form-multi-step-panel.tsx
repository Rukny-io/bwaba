  ...
  return (
    ...
    >
      ...
      <div className="space-y-5">
        <div className="flex items-start justify-between gap-4 rounded-2xl border border-[var(--border)]/50 bg-[var(--surface-secondary)]/20 px-4 py-3">
          <div>
          ...
          <>
            ...
            <div className="space-y-3">
              ...
              {steps.map((step, index) => (
                <div
                  key={step.clientKey}
                  className="space-y-3 rounded-2xl border border-[var(--border)]/60 p-4"
                >
