...
export function FormIntegrationCard({
  ...
  return (
    <article
      className={cn(
        'flex h-full flex-col rounded-2xl border border-[var(--border)]/80 bg-[var(--surface)] p-4 shadow-sm shadow-black/[0.02] transition-all duration-200 sm:rounded-3xl sm:p-6',
        !comingSoon &&
          'hover:border-[var(--border)] hover:shadow-md hover:shadow-black/[0.04]',
