...
/** One odometer column: a 0–9 strip translated to reveal the active digit. */
...
/**
 * Animated number with a rolling-digit (odometer) effect.
 * Each digit smoothly rolls to its new value when `value` changes.
 */
