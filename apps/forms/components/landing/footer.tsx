...
const footerConfig = {
  ...
  columns: [
    ...
    },
    {
      title: "القانونية",
      links: [
        { label: "سياسة الخصوصية", href: PRIVACY_URL, external: true },
        { label: "شروط الاستخدام", href: TERMS_URL, external: true },
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-800 flex flex-col sm:flex-row justify-between items-center text-xs text-gray-500 dark:text-gray-400 gap-4">
          ...
          <div className="flex gap-6">
            <a href={PRIVACY_URL} className="hover:text-primary transition-colors">
              الخصوصية
            </a>
            <a href={TERMS_URL} className="hover:text-primary transition-colors">
              الشروط
            </a>
