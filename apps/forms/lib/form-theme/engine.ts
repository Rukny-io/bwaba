...
/** @see resolveFontStack in @/lib/fonts */
export { resolveFontStack as resolveFormFontStack } from '@/lib/fonts';
...
export function themeToCssVariables(theme: FormTheme): CSSProperties {
  ...
  const fontStack = resolveFontStack(theme.typography.fontFamily);
