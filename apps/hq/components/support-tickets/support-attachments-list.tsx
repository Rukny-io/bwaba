...
import type { SupportTicketAttachment } from '@/lib/types/support-tickets';
        ...
        <li key={file.id}>
          {isImageAttachment(file) ? (
            <a
              ...
              className="block overflow-hidden rounded-xl bg-[var(--surface-secondary)]/80"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1.5 text-xs font-medium text-[var(--primary)] underline-offset-2 hover:underline"
            >
