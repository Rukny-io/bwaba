        ...
        <div className="grid gap-10 lg:grid-cols-2 lg:gap-14" dir="ltr">
          <div>
            ...
            <h2
              ...
              style={{ color: TEXT }}
            >
              Rukny — one platform for your online business
            </h2>
            <div
            ...
            >
              <p>
                <strong style={{ color: TEXT }}>Rukny</strong> (ركني) is an
                Arabic-first SaaS platform that helps creators, small businesses,
                and teams launch and run their digital presence from a single
                dashboard.
              </p>
              <p>
          ...
          >
            ...
            <p
              ...
              style={{ color: MUTED }}
            >
              When a user connects Google, Rukny requests access only to support
              features they explicitly enable:
            </p>
            <ul
