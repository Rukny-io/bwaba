...
export async function middleware(request: NextRequest) {
  ...
  if (
    ...
    // Dev: allow any parent (LAN IP, localhost, etc.). Prod: dashboard origin only.
    securityOptions = {
      ...BASE_SECURITY_OPTS,
