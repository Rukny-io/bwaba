...
const FOOTER_COLUMNS: FooterColumn[] = [
  ...
  },
  {
    title: 'الموارد',
    links: [
      { label: 'الوثائق', href: '#about' },
      { label: 'المطورون', href: '#about' },
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'إنشاء متجر', href: '#products' },
      { label: 'إنشاء نموذج', href: '#products' },
    ],
  },
  {
    title: 'القانوني',
        ...
        <div className="rounded-[2rem] bg-white p-7 sm:p-8 md:p-10">
          <div className="grid gap-8 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)] lg:items-center lg:gap-12">
            ...
            <div className="flex flex-col gap-3 sm:flex-row lg:justify-end">
              ...
              <Link href="#pricing" className={`${agLayout.btnSecondary} sm:min-w-[10rem]`}>
                للمؤسسات
              </Link>
            </div>
          </div>
