...
function getNavClasses(isActive: boolean) {
  return `relative group flex size-10 items-center justify-center rounded-3xl transition-all duration-200 ${
    isActive
  ...
  return (
    <aside className="fixed top-0 right-4 z-40 hidden h-full w-14 flex-col items-center py-5 sm:flex">
      ...
      <div className="flex flex-1 items-center justify-center">
        <div className="dashboard-card flex flex-col items-center rounded-3xl px-2 py-4">
      ...
      <div className="flex flex-col items-center gap-2">
        <button
          ...
          className="group relative flex size-10 items-center justify-center rounded-3xl text-[var(--muted-foreground)] transition-all duration-200 hover:bg-red-50 hover:text-red-500"
        >
